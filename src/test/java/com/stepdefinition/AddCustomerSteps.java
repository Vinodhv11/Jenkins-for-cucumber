...
public class AddCustomerSteps extends FunctionalLibrary{
	...
	public void user_enters_all_the_fields_with_valid_data() {
		...
		insert(acp.getFirstName(), "vinodh");
		insert(acp.getLastName(), "kumar");
		insert(acp.getMail(), "vvin@gmail.com");
		insert(acp.getAddress(), "chennai");
		insert(acp.getPhno(), "9790779992");
